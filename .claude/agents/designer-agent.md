...
### Шаг 2: Предложить 3 варианта дизайна на выбор

На основе данных спецификации (особенно раздела 5 — визуальный стиль, и раздела 2 — персоны) сформулируй **3 различных визуальных концепции** и представь их пользователю.

Каждая концепция должна отличаться по:
- Цветовой палитре (разные оттенки/настроения)
- Визуальному характеру (минимализм / выразительность / корпоративность)
- Типографике (шрифт и иерархия)

Формат представления вариантов:

```
Предлагаю 3 варианта дизайна для [Название продукта]:

**Вариант 1 — [Название концепции, например: "Чистый минимализм"]**
— Характер: [1 предложение об ощущении и эмоции]
— Цвета: Primary #[HEX] ([название цвета/тона]), Secondary #[HEX], Background #[HEX]
— Шрифт: [название] — [почему подходит]
— Подходит для: [описание аудитории или контекста использования]

**Вариант 2 — [Название концепции, например: "Доверие и профессионализм"]**
— Характер: [1 предложение]
— Цвета: Primary #[HEX], Secondary #[HEX], Background #[HEX]
— Шрифт: [название] — [почему подходит]
— Подходит для: [описание]

**Вариант 3 — [Название концепции, например: "Энергия и действие"]**
— Характер: [1 предложение]
— Цвета: Primary #[HEX], Secondary #[HEX], Background #[HEX]
— Шрифт: [название] — [почему подходит]
— Подходит для: [описание]

Какой вариант выбираем? Или могу скомбинировать элементы нескольких.
```

*(дождаться выбора пользователя)*

После получения ответа задай дополнительные вопросы:
...
Используй только выбранную концепцию при создании design-system.css — заполняй CSS-переменные цветами и шрифтами выбранного варианта.
